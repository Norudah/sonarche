...
_BUCKETS: dict[str, tuple[str, ...]] = {
    "Metal": (
        ...
        "industrial death metal", "mathcore", "medieval metal", "melodic death metal",
        "metalcore", "neoclassical metal", "pagan metal", "power metal", "progressive metal",
    ...
    "Rock": (
        ...
        "hard rock", "hardcore punk", "horror punk", "indie pop", "indie rock", "krautrock",
        "math rock", "neo-psychedelia", "new prog", "new wave", "no wave", "noise pop",
        "noise rock", "nu metal", "oi!", "paisley underground", "pop punk", "pop rock",
        "post-britpop", "post-grunge", "post-hardcore", "post-metal", "post-punk", "post-rock",
        "power pop", "powerviolence", "progressive rock", "psychedelic rock", "psychobilly",
        "punk rock", "raga rock", "riot grrrl", "rock", "rock and roll", "sadcore", "screamo",
        "shoegaze", "ska punk", "skate punk", "slowcore", "southern rock", "surf rock",
    ...
    "Electronic": (
        ...
        "hi-nrg", "hip house", "house", "idm", "illbient", "indietronica", "industrial metal",
        "industrial rock", "italo dance", "italo disco", "italo house", "jumpstyle", "jungle",
        "liquid funk", "lowercase", "madchester", "neue deutsche härte", "new beat",
        ...
        "space rock", "speed garage", "speedcore", "synthcore", "synthpop", "synthpunk",
